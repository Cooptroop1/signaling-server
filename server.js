...
// Updated: Relaxed base64 validation to allow padding variations and log invalid ones
...
const isValid = base64Regex.test(sanitized) && sanitized.length % 4 === 0;
...
if (payload && payload.length > 9333333) { // ~7MB base64 for 5MB file (510241024*4/3 ≈ 6.99MB chars)
